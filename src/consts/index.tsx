...
export const PAGES_CONTENT: Record<string, PageContent> = {
    ...
    'buy-now': {
        ...
        solution: [
            {
                number: 1,
                content: 'Проведение анализа рынка и заинтересованности продавца/потребителя. Прорабатываем техническое задание и документацию исходя из запросов нашего клиента.'
            },
            {
                number: 2,
                content: 'Разработка сайта для десктопных операционных систем и приложения для android и iOS, с учетом потребности клиента и особенностей дизайна.'
            },
            {
                number: 3,
                content: 'Создание высоконагруженной системы, способной выдержать большой поток потребителей.'
            }
        ],
    },
    'erp': {
        ...
        solution: [
            {
                number: 1,
                content: 'Аналитика, сбор информации и требований заказчика к будущей системе.\n' +
                    'Анализ процессов, происходящих в офисе и на производстве. Расписываем техническое задание на основе проведенной аналитики и собранных требований.'
            },
            {
                number: 2,
                content: 'На предприятии нарушен процесс коммуникации из-за которого возникает множество различных сложностей. Мы решили закрыть эту часть проблем реализаций таск-трекера и совмещенного с ним документооборота, заточенного под нужды офиса и производства.'
            },
            {
                number: 3,
                content: 'Прототипирование будущей системы и создание полноценного дизайн-интерфейса системы.'
            }
        ],
    },
    'sgmk': {
        ...
        solution: [
            {
                number: 1,
                content: 'Анализ и разработка ТЗ, где делали акцент на важности компании в её технологической области.'
            },
            {
                number: 2,
                content: 'Разработка макета, где чётко виден упор в сторону престижности и статусности SGMK  и свежий взгляд на компанию для её ЦА.'
            }
        ],
    },
    'about-education': {
        ...
        solution: [
            {
                number: 1,
                content: 'Анализ конкурентов, проработка технического задания и документации исходя из запросов клиента.'
            },
            {
                number: 2,
                content: 'Разработка платформы, отвечающей всем требованиям Минобразования и стандартам UI/UX-дизайна. Упор был на создание четного разделения функциональности платформы для пользователей, в зависимости от назначенной роли.'
            },
            {
                number: 3,
                content: 'Разработка сайта-лендинга, предоставляющая подробную информацию как о компании в целом, так и о самом платформе “ПроОбразование” в частности.'
            },
            {
                number: 4,
