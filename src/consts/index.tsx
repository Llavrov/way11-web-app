...
export const CARDS_OF_CASES = {
    ...
    lancelot: {
        ...
        background: '#007FE0',
        description: 'Создание и проведение вебинаров становится быстрым и удобным процессом благодаря нашей бизнес-модели. Пользователь может создать мероприятие за несколько секунд и отправить ссылку для регистрации зрителям.',
        link: '/case/lancelot',
    },
    aboutEducation: {
