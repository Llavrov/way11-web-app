        ...
        <div className="flex flex-col gap-3">
            ...
            >
                ...
                <div className="w-full h-full flex justify-center items-center box-border">
                    <Image className="aspect-video absolute -bottom-10 lg:min-h-[250px] lg:object-cover rounded-5 -rotate-12 box-border object-contain flg:w-[80%] flg:h-[80%] lg:-right-6 lg:object-left lg:bottom-auto lg:w-[90%] lg:rotate-0" src={photo} width={658} height={375} alt={title} />
                </div>
            </div>
