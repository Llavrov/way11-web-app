    ...
    return (
        ...
        >
            ...
            <div
                ...
                className="flex justify-end items-end absolute top-0 left-0 z-10 rounded-10 w-full h-full border border-solid border-white bg-card-hover"
            >
            ...
            <div className="w-full h-full flex justify-center items-center box-border">
                <Image className="absolute bottom-[-25px] rounded-5 lg:-right-6 lg:object-left lg:bottom-auto lg:w-[90%] aspect-video box-border object-cover flg:w-[80%] flg:h-[80%] rounded-t-5" src={photo} width={658} height={375} alt={title} />
            </div>
        </div>
    )
}
