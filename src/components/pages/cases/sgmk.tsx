    ...
    return (
        <div className="flex flex-col gap-3">
            <div
                ...
                className="relative w-full h-[500px] max-w-[790px] flg:w-[60vw] flg:h-[60vh] flg:max-w-[calc(60vw-50px)] p-6 sm:p-2 sm:pt-4 rounded-10 overflow-hidden lg:rounded-5"
