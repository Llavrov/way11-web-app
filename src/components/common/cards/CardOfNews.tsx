    ...
    return (
        <Link href={link}>
            <div className="flex flex-col overflow-hidden justify-between h-[463px] lg:h-[367px] w-[390px] min-w-[390px] max-w-[390px] lg:min-w-[262px] lg:max-w-[262px] rounded-5 box-border bg-white">
                <Image className="object-cover w-[calc(100%+100px)] object-left h-full max-w-[390px] max-h-[390px] rounded-5 overflow-hidden" src={image} alt={title} width={390} height={350} />
